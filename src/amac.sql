...
CREATE TABLE `fund` (
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1554440 DEFAULT CHARSET=utf8 COMMENT='http://gs.amac.org.cn/amac-infodisc/res/pof/fund/index.html';
...
CREATE TABLE `fund_account` (
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=487487 DEFAULT CHARSET=utf8;
...
CREATE TABLE `fund_account_detail` (
  ...
  `register_date` date DEFAULT NULL COMMENT '备案日期',
  `contract_period` varchar(45) DEFAULT NULL COMMENT '合同期限（月）',
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=363120 DEFAULT CHARSET=utf8;
...
CREATE TABLE `fund_detail` (
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1411954 DEFAULT CHARSET=utf8;
...
CREATE TABLE `manager` (
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=486796 DEFAULT CHARSET=utf8 COMMENT='http://gs.amac.org.cn/amac-infodisc/res/pof/manager/index.html';
...
CREATE TABLE `manager_detail` (
  ...
  `register_capital` double DEFAULT NULL COMMENT '注册资本（万元）',
  `paid_capital` double DEFAULT NULL COMMENT '实缴资本（万元）',
  ...
  `legal_representative` varchar(45) DEFAULT NULL COMMENT '法人',
  `general_manager` varchar(45) DEFAULT NULL COMMENT '总经理',
  `risk_control_manager` varchar(45) DEFAULT NULL COMMENT '合规风控',
  `create_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=488782 DEFAULT CHARSET=utf8 COMMENT='http://gs.amac.org.cn/amac-infodisc/res/pof/manager/138.html';
...
CREATE TABLE `qh` (
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22645 DEFAULT CHARSET=utf8;
...
CREATE TABLE `qh_detail` (
  ...
  `update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26062 DEFAULT CHARSET=utf8;
